...
| <a name="module_s3bucket_splunk_logs"></a> [s3bucket\_splunk\_logs](#module\_s3bucket\_splunk\_logs) | git::https://github.com/NHSDigital/nhs-notify-shared-modules.git//infrastructure/modules/s3bucket | v1.0.0 |
## Outputs
