"""
Taken from https://github.com/ptdavies17/CloudwatchFH2HEC/blob/master/Cloudwatch2FH2HEC.py
at the recomendation of https://www.splunk.com/en_us/blog/tips-and-tricks/how-to-ingest-any-log-from-aws-cloudwatch-logs-via-firehose.html
...
def transformLogEvent(log_event, acct, arn, loggrp, logstrm, filterName):
    ...
    str: The transformed log event.
        ...
        sourcetype is set as -
            aws:lambda if the Log Group name contains lambda
            aws:cloudwatch for all other cases
    """
